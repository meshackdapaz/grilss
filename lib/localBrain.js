...
🍟 *SIDES*: Peri Peri Fries (3k), Lemon Fries (4k), Rice (4k), Mash (4k).`;
    ...
    async getResponseFromHistory(prompt, history = []) {
        ...
        // 3. ORDERING FOOD (Full Menu Logic)
        if (text.match(/(steak|bone|ribeye|wings|nundu|poutine|chicken|strips|tomahawk|sirloin|platter|ribs|choma|kuku|chips|nataka)/)) {
        ...
        // 4. LOCATION
        if (text.match(/(wapi|location|mahali|place|mpo wapi|upanga|ramani)/)) {
